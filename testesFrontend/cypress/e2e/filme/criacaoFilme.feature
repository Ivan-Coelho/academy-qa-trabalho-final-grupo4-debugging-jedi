...
Funcionalidade: Criação de filme
    ...
    Contexto: Cadastro de filme usuario adminstrador
        ...
        Cenario: Usuário administrador cadastra um filme com dados válidos
        ...
        Cenario: Usuário administrador tenta cadastrar um filme com dados incompletos
        ...
        Cenario: Usuário administrador tenta cadastrar um filme com quantidade de caracteres do titulo invalidos
            Quando o usuário cadastrar um novo filme com titulo invalido
            Entao o filme não é cadastrado
            E uma mensagem de erro é exibida
        

        Cenario: Usuário administrador tenta cadastrar um filme com quantidade de caracteres do gênero invalidos
            Quando o usuário cadastrar um novo filme com genero invalido
            Entao o filme não é cadastrado
            E uma mensagem de erro é exibida
        

        Cenario: Usuário administrador tenta cadastrar um filme com quantidade de caracteres da descrição invalidos
            Quando o usuário cadastrar um novo filme com descrição invalida
            Entao o filme não é cadastrado
            E uma mensagem de erro é exibida
        

        Cenario: Usuário administrador tenta cadastrar um filme com data de lançamento fora do intervalo perimitido
            Quando o usuário cadastrar um novo filme com data de lançamento invalida
            Entao o filme não é cadastrado
            E uma mensagem de erro é exibida
        

        Cenario: Usuário administrador tenta cadastrar um filme com duração fora do intervalo perimitido
