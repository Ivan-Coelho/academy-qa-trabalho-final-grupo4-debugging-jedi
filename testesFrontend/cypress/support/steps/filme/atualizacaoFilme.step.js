...
When('fornecer todas as informações necessárias', function () {
...
Given ('que um usuário comum tenta atualizar um filme', function () {
...
When('atualizar um filme cujo Id não está presente no catálogo', function () {
...
When('atualizar um filme inserindo mais de 100 caracteres no título', function () {
...
When('atualizar um filme inserindo 100 caracteres no gênero', function () {
...
When('atualizar um filme com descrição de 1 caracter', function () {
...
When('atualizar um filme com descrição de 500 caracteres', function () {
...
When('atualizar um filme com ano de lançamento 1895', function () {
...
When('atualizar um filme com ano de lançamento 1894', function () {
...
When('atualizar um filme com 720 horas de duração', function () {
...
When('atualizar um filme com menos de 1 minuto de duração', function () {
